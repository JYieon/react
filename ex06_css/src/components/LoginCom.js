...
const LoginBox = styled.div`
    ...
    .logo-area{
        ...
        border-botton: 1px dotted olive;
        padding-botton: 5px; width: 50%; margin: 0 auto;
        a{ color: darkcyan; &:hover{ color: cyan; } }
    }
`
const StyledInput = styled.input`
    color: gray; font-size: 20px; margin-top: 10px;
    border: none; outline: none; border-bottom: 1px solid lightgray;
            ...
            <LoginBox>
                ...
                <form style={{width:"80%", margin:"10px auto"}}>
                    ...
                    <StyleButton width="100%"
                        background={[178,238,244]}>로그인</StyleButton>
                </form>
            </LoginBox>
        </AuthBlock>
    )
